...
class BosonMixtureCluster_4thorder: public IPhysicalSystem
{
protected:
...
public:
	...
	~BosonMixtureCluster_4thorder();

//Implementation of IPhysicalSystem
public:
	BosonMixtureCluster_4thorder(vector<double>& params, string configDirectory);
