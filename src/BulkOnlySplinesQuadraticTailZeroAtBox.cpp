...
BulkOnlySplinesQuadraticTailZeroAtBox::BulkOnlySplinesQuadraticTailZeroAtBox(string configDirectory) : IPhysicalSystem()
{
...
void BulkOnlySplinesQuadraticTailZeroAtBox::InitSystem()
{
	grBinCount = 100;
	grBinStartIndex = 3;
	numOfkValues = 300;
...
vector<double> BulkOnlySplinesQuadraticTailZeroAtBox::GetCenterOfMass(vector<vector<double> >& R)
{
	vector<double> com = {0.0, 0.0, 0.0};
	return com;
}

void BulkOnlySplinesQuadraticTailZeroAtBox::CalculateExpectationValues(vector<vector<double> >& R, vector<double>& uR, vector<double>& uI, double phiR, double phiI)
{
...
void BulkOnlySplinesQuadraticTailZeroAtBox::CalculateAdditionalSystemProperties(vector<vector<double> >& R, vector<double>& uR, vector<double>& uI, double phiR, double phiI)
{
    ClearVector(additionalSystemProperties);
...
void BulkOnlySplinesQuadraticTailZeroAtBox::CalculateWavefunction(vector<vector<double> >& R, vector<double>& uR, vector<double>& uI, double phiR, double phiI)
{
	double sum = 0;
	double interval;
	int bin;
...
void BulkOnlySplinesQuadraticTailZeroAtBox::CalculateWFChange(vector<vector<double> >& R, vector<double>& uR, vector<double>& uI, double phiR, double phiI, int changedParticleIndex, vector<double>& oldPosition)
{
	double sum = 0;
...
double BulkOnlySplinesQuadraticTailZeroAtBox::CalculateWFQuotient(vector<vector<double> >& R, vector<double>& uR, vector<double>& uI, double phiR, double phiI, int changedParticleIndex, vector<double>& oldPosition)
{
...
void BulkOnlySplinesQuadraticTailZeroAtBox::AcceptMove()
{
	wf = wfNew;
